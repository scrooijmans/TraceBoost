...
class TraceBoostApp:
    ...
    def prepare_survey_demo(
        ...
        *,
        ...
        transform_id = self.ensure_demo_survey_time_depth_transform(store_path)
        velocity_models = self.load_velocity_models(store_path)
        survey_map = self.resolve_survey_map(
            store_path,
            display_coordinate_reference_id=display_coordinate_reference_id
        )
        return {
            "store_path": store_path,
            "ensured_time_depth_transform_id": transform_id,
